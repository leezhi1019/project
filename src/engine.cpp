...
void setup()
{
    ...
    AudioManager::loadMusic("../audio/game_bgm.wav");                // Load the background music file
    AudioManager::loadSoundEffect("../audio/detected_by_enemy.mp3"); // Load the detected sound effect
    AudioManager::playMusic();                                       // Play the background music to test if it loads correctly
}
